...
public class ProductWithMustardTest {

    private static final int ONE_HUNDRED = 100;
    private static final int ONE_HUNDRED_AND_ONE = 101;
    ...
    public void setUp() throws Exception {
        ...
        testSubject = new ProductWithMustard(innerProduct);
    }
    ...
    public void testConsumeShouldBeGoodWhenGuestIsValid() throws Exception {
        ...
        Mockito.verify(guest).setHappiness(Matchers.eq(BigDecimal.valueOf(ONE_HUNDRED_AND_ONE)));
